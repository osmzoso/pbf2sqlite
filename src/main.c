...
static char *help =
  ...
  "  vaddr <lon1> <lat1> <lon2> <lat2> <htmlfile>        Creates a map of the addresses\n"
  "  vgraph <lon1> <lat1> <lon2> <lat2> <htmlfile>       Creates a map of the graph\n"
  "  sql <stmt>                                          Executes an SQL statement\n"
  "  sql                                                 Reads SQL statement from STDIN\n"
